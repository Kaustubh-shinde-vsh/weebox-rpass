console.log("moodle/moodleTemplate");
var moodleTemplate = new (function () {
  function b() {
    return (
      ...
      ' alt="camera image" /></div></div><div class="info-section"><b class="_i18" data-i18="TEXT_NOTE"></b>: <span class="_i18" data-i18="CHECK_SYS_INST_MSG_1"></span></div><div class="action-section text-center"><button class="btn cancel _i18" data-i18="TEXT_CANCEL" id="close"></button><button class="btn btn-primary continue-btn _i18" data-i18="TEXT_CONTINUE" id="continue"></button></div></div> </div>'
    );
  }
  function a() {
    return (
      ...
      chrome.runtime.getURL("assets/logo.png") +
      ' alt="logo" /></div><div class="title-heading text-center _i18" data-i18="START_QUIZ_MSG_1"></div><div class="chat-section text-center"><div class="chat-img"><img src=' +
